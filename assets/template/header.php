<header class="app-header"><a class="app-header__logo" href="index.html">Sistem Surat</a>
    ...
    <ul class="app-nav">
        <li><a class="app-nav__item" href="javascript:void()" ng-click="logout()"><i class="fa fa-sign-out fa-lg"></i> Logout</a></li>
...
<aside class="app-sidebar">
    <div class="app-sidebar__user">
        ...
        <div>
        <a href="javascript:void()" ng-click="detailpegawai()" style="margin:auto"><img class="app-sidebar__user-avatar"
        ng-src="{{photo}}" alt="User Image"  style="width:48px; height: 48px"></a>
    ...
    <ul class="app-menu">
        ...
        <li ng-if="adminakses" ng-class="{'treeview is-expanded': active === 'Struktural' || active === 'Kriteria' || active === 'Mahasiswa' || active === 'Detail Mahasiswa' || active === 'Pegawai' || active === 'Detail Pegawai',
            ...
            <ul class="treeview-menu">
                <li ng-if="adminakses"><a ng-class="{'app-menu__item active': active === 'Struktural', 'app-menu__item':active !== 'Struktural' }" href="{{url}}/admin/struktural"><i class="icon fa fa-circle-o"></i> &nbsp;Struktur</a></li>
                <li ng-if="adminakses"><a ng-class="{'app-menu__item active': active === 'Kriteria', 'app-menu__item':active !== 'Kriteria' }" href="{{url}}/admin/kriterium"><i class="icon fa fa-circle-o"></i> &nbsp; Kriteria Surat</a>
                </li>
                ...
                <li ng-if="adminakses"><a ng-class="{'app-menu__item active': active === 'Pegawai', 'app-menu__item':active !== 'Pegawai' }" href="{{url}}/admin/pegawai"><i class="icon fa fa-circle-o"></i> &nbsp; Pegawai</a>
                </li>
                </li>
            </ul>
        </li>
        <li ng-if="adminakses"><a ng-class="{'app-menu__item active': active === 'Pejabat', 'app-menu__item':active !== 'Pejabat' }"
